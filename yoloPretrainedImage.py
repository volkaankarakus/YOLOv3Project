...
colors =["200,255,180","0,0,255","255,0,0","120,150,160","50,40,20","90,0,70"]
...
for detectionLayer in detectionLayers:
    for objectDetection in detectionLayer:
        ...
        if confidence >0.60:
            ...
            cv2.rectangle(img,(startX,startY),(endX,endY),boxColor,2)
            cv2.putText(img,label,(startX,startY-10),cv2.FONT_HERSHEY_SIMPLEX,0.5,boxColor,2)
            #0.5 boyut girdik.
